...
lib_path = os.path.realpath(script_path + '/../lib')
import ctypes
from ctypes import cdll
# dxl_lib = cdll.LoadLibrary(lib_path + "/dxl_x86_c.dll")  # for windows 32bit
# dxl_lib = cdll.LoadLibrary(lib_path + "/dxl_x64_c.dll")  # for windows 64bit
# dxl_lib = cdll.LoadLibrary(lib_path + "/libdxl_x86_c.so")   # for linux 32bit
dxl_lib = cdll.LoadLibrary(lib_path + "/libdxl_x64_c.so")     # for linux 64bit
# dxl_lib = cdll.LoadLibrary(lib_path + "/libdxl_sbc_c.so")   # for SBC linux
# dxl_lib = cdll.LoadLibrary(lib_path + "/libdxl_mac_c.dylib")# for Mac OS
